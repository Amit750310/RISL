...
namespace BL
{
    public class ClsProjectMasterBL
    {
        ...
        public DataTable Getallcategory()
        {
            ...
            dt = bc.GetDatatable("Prc_select_all_project", CommandType.StoredProcedure);
            return dt;
        }
        public string Insertcategory(ClsProjectMasterML obj)
        {
            con.Open();
            ...
            cmd.CommandText = "Prc_Insert_Project_master";
