...
namespace BL
{
    public class ClsvendorsBL
    {
        ...
        public DataTable getvendorsLIST(ClsvendorsML prp)
        {
            ...
            objSqlParam[2] = new SqlParameter("@vendorName", prp.VendorName);
            BaseCommon bc = new BaseCommon();
            dt = bc.GetDatatable("prc_GetvendorsLIST", CommandType.StoredProcedure, objSqlParam);
            return dt;
        }
    ...
    public class clsvendorcategorylist
    {
