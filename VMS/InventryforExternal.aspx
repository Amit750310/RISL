<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InventryforExternal.aspx.cs" Inherits="vms.InventryforExternal" %>
                ...
                <div class="form form-horizontal">
                    ...
                    <div id="divfillgrid" runat="server" class="form form-horizontal" style="display: block;">
                        ...
                        &nbsp;
                         ...
                         <div class="btn-group pull-right">
                           <asp:Button ID="BtnAllinventroy" runat="server" Visible="false" CssClass="btn btn-info" Text="All Inventroy"  OnClick="BtnAllinventroy_Click"/>
                          </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="form-group">
                               ...
                               <div class="col-sm-4">
                                    ...
                                    <asp:Dropdownlist ID="drdLocationName" runat="server" CssClass="form-control" AutoPostBack="true" AppendDataBoundItems="true">
                                    </asp:Dropdownlist>
                                </div>
