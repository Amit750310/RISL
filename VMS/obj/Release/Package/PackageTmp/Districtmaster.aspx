<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Districtmaster.aspx.cs" Inherits="vms.Districtmaster" %>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:Label ID="lblcategory_id" runat="server" Text='<%#Eval("State_ID") %>' Visible="false"></asp:Label>
                                                <asp:Label ID="lblsubcategory_id" runat="server" Text='<%#Eval("Distict_ID") %>' Visible="false"></asp:Label>
                                            </td>
                                            <td>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:DropDownList ID="drdcategoryname" runat="server" CssClass="form-control" AppendDataBoundItems="True">
