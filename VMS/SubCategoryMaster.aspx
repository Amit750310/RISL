<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubCategoryMaster.aspx.cs" MasterPageFile="~/Site.Master" Inherits="vms.SubCategoryMaster" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:Label ID="lblcategory_id" runat="server" Text='<%#Eval("category_Id") %>' Visible="false"></asp:Label>
                                                 <asp:Label ID="lblsubcategory_id" runat="server" Text='<%#Eval("subcategory_Id") %>' Visible="false"></asp:Label>
                                            </td>
                                            <td>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <label class="control-label">
                                    category Name <span class="red-info">* </span>:</label>
                            ...
                            <div class="col-sm-3">
                                <label class="control-label">
                                    Product Name <span class="red-info">* </span>:</label>
