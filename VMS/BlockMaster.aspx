<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BlockMaster.aspx.cs" Inherits="vms.BlockMaster" %>
    ...
    <script type="text/javascript">
        <%--function ValidateSave() {
            if (document.getElementById('<%=txtsubcategory.ClientID %>').value.trim() == "") {
                document.getElementById('<%=txtsubcategory.ClientID %>').style.border = '1px solid red';
                document.getElementById('<%=txtsubcategory.ClientID %>').focus();
                return false;
            } return true;
        }--%>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:Label ID="LbldistID" runat="server" Text='<%#Eval("DistrictID") %>' Visible="false"></asp:Label>
                                                <asp:Label ID="IblID" runat="server" Text='<%#Eval("ID") %>' Visible="false"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblsubcategoryname" runat="server" Text='<%#Eval("DistrictName") %>'></asp:Label>
                                            </td>
                                            <td>
                        ...
                        <div class="form-group">
                            <div class="col-sm-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:DropDownList ID="drdstate" runat="server" CssClass="form-control" AppendDataBoundItems="True" AutoPostBack="true" OnSelectedIndexChanged="drdstate_SelectedIndexChanged">
                              ...
                              <div class="col-sm-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon bg"><i class="ion-plus"></i></span>
                                    <asp:DropDownList ID="drddistrict" runat="server" CssClass="form-control" AppendDataBoundItems="True">
                                    </asp:DropDownList>
                                </div>
                                <!-- /input-group -->
                            </div>
                            <div class="col-sm-3">
                                <label class="control-label">
                                    Block Name <span class="red-info">* </span>:</label>
