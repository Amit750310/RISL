<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RequestMaster.aspx.cs" Inherits="vms.RequestMaster" %>
<asp:Content ID="content1" runat="server" ContentPlaceHolderID="head">
    ...
    <script type="text/javascript">
        ...
        <td>${rowCount + 1}</td>
        <td>
            <select class="form-control"  name="drd" onchange="updateUnitCost(this)">
    ...
    `;
        ...
        function updateTotal() {
            ...
            for (let i = 0; i < rows.length; i++) {
                ...
                let price = parseFloat(rows[i].cells[5].getElementsByTagName("input")[0].value) || 0;
                const unitCost = price * quantity;
                const totalAmount =  unitCost;
    ...
    <script type="text/javascript">
        ...
        function saveServiceItems() {
            ...
            $.ajax({
                type: "POST",
                url: "RequestMaster.aspx/SaveServiceItems",
                data: JSON.stringify({
                ...
                success: function (response) {
                    window.location.href = "RequestMaster.aspx";
            ...
            <div class="panel-body" style="min-height: 400px">
                <div class="form form-horizontal">
                                ...
                                <asp:Repeater ID="rptBind" runat="server" OnItemCommand="rptBind_ItemCommand">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>Pending</td>
                                            <td>
                                                <asp:Button ID="imgbtnEdit" class="btn btn-primary btn-icon-primary" Text="View"
                    ...
                    <div class="clearfix"></div>
                      ...
                      <div style="overflow-x: auto;  overflow-y: auto; height:auto" id="ShowDetails" runat="server" visible="false">
                        ...
                        <div class="form-group">
                            <div class="col-sm-2">
                                <label class="control-label">
                                     Total inventry <span class="red-info">=60</span><br />
                                     VC inventry <span class="red-info">=20</span><br />
                                     IPhone inventry <span class="red-info">=20</span><br />
                                     Display inventry <span class="red-info">=20</span>
                                </label>
                    ...
                    <div class="clearfix"></div>
                    <div id="div1" runat="server" class="form form-horizontal" visible="false">
                     ...
                     <div class="clearfix"></div>
                    <div id="div3" runat="server" height="Auto" class="form form-horizontal" visible="false">
