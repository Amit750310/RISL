...
namespace vms
{
    ...
    {
        ClsProjectMasterBL tblcategory = new ClsProjectMasterBL();
        string flag;
        ...
        protected void rptRole_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                string Rcode = ((Label)e.Item.FindControl("lblProjectID")).Text;
                string name = ((Label)e.Item.FindControl("lblProjectName")).Text;
        ...
        {
            ClsProjectMasterML obj = new ClsProjectMasterML();
            obj.ProjectName = txtcategory.Text.Trim();
            obj.mode = flag;
            obj.ProjectID = hfcategory_ID.Value;
